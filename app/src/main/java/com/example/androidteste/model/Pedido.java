...
public class Pedido implements Serializable {
    ...
    public void salvar(){
        ...
        DatabaseReference dataStatusPedidoEmpresa = empresaRef
                .child("dataStatusPedido");
        dataStatusPedidoEmpresa.setValue(ServerValue.TIMESTAMP);
        ...
        DatabaseReference dataStatusPedidoUsuario = usuarioRef
                .child("dataStatusPedido");
        dataStatusPedidoUsuario.setValue(ServerValue.TIMESTAMP);
