...
import com.example.androidteste.activity.empresas.EmpresaFormProdutoActivity;
import com.example.androidteste.adapter.CategoriaAdapter;
...
public class EmpresaProdutoFragment extends Fragment implements ProdutoAdapterEmpresa.OnClickListener {
    ...
    private void configCliques(){
        fab_add.setOnClickListener(view -> startActivity(new Intent(requireActivity(), EmpresaFormProdutoActivity.class)));
