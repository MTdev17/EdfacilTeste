...
import com.example.androidteste.adapter.CarrinhoAdapter;
import com.example.androidteste.adapter.ProdutoCarrinhoAdapter;
...
public class CarrinhoActivity extends AppCompatActivity implements CarrinhoAdapter.OnClickListener, ProdutoCarrinhoAdapter.OnClickListener {
    ...
    private void showBottomSheet(){
        ...
        ib_add.setOnClickListener(view1 -> addQtdItem());
        ib_remove.setOnClickListener(view1 -> delQtdItem());
    ...
    private void addQtdItem(){
        ...
        text_atualizar.setOnClickListener(view -> {
            atualizarItem();
        });
    ...
    private void configCliques(){
        ...
        btn_continuar.setOnClickListener(view -> continuar());

        ll_endereco.setOnClickListener(view -> {
            Intent intent = new Intent(this, UsuarioSelecionaEnderecoActivity.class);
            startActivityForResult(intent, REQUEST_ENDERECO);
        });

        text_escolher_pagamento.setOnClickListener(view -> {
