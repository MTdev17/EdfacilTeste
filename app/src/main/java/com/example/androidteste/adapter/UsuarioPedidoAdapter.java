...
public class UsuarioPedidoAdapter extends RecyclerView.Adapter<UsuarioPedidoAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(pedido.getStatusPedido() == StatusPedido.CANCELADO_USUÁRIO ||
        ...
        if(pedido.getItemPedidoList().size() > 1){
            holder.text_mais_itens.setText(context.getString(R.string.mais_item,
                    pedido.getItemPedidoList().size() - 1));
        ...
        holder.btn_ajuda.setOnClickListener(view -> onClickListener.OnClick(pedido, 0));
        holder.btn_detalhes.setOnClickListener(view -> onClickListener.OnClick(pedido, 1));
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView text_empresa, text_status_pedido, text_data_pedido, text_qtd_item_pedido, text_nome_item_pedido, text_mais_itens;
