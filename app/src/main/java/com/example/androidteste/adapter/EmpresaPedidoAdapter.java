...
public class EmpresaPedidoAdapter extends RecyclerView.Adapter<EmpresaPedidoAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.btn_status.setOnClickListener(view -> onClickListener.OnClick(pedido, 0));
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView text_cliente, text_status_pedido, text_data_pedido, text_qtd_item_pedido, text_nome_item_pedido, text_mais_itens;
